...
---------
LinearRegression
    Basic (Multiple) Linear Regression tool

        y = b0 + b1*x1 + ... + bn*xn

    where b0...bn are the estimated coefficients and x1...xn are indipendent
    1D variables.
...
PolynomialRegression
    ...
    where b0...bn are the estimated coefficients and x is an indipendent
    1D variable.
...
PowerRegression
    Regression tool fitting the model
        ...
        y = a_0*x_0^b_0 + a_1*x_1^b_1 + ... + a_n*x_n^b^n

    where a_0...a_n and b_0...b_n are the estimated coefficients and x_0...x_n
    are indipendent 1D variables.
...
ExponentialRegression
    ...
    where a and c are the estimated coefficients, b is the base of the exponent
